 ...
 * @generated
 */
public class AlfrescoUserTaskImpl extends UserTaskImpl implements
		AlfrescoUserTask {
	/**
	...
	public void setRunAs(String newRunAs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.ALFRESCO_USER_TASK__RUN_AS, oldRunAs, runAs));
	}
	...
	public void setScriptProcessor(String newScriptProcessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.ALFRESCO_USER_TASK__SCRIPT_PROCESSOR,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AlfrescoScriptBase.class) {
			...
			case Bpmn2Package.ALFRESCO_SCRIPT_BASE__RUN_AS:
				return Bpmn2Package.ALFRESCO_USER_TASK__RUN_AS;
			case Bpmn2Package.ALFRESCO_SCRIPT_BASE__SCRIPT_PROCESSOR:
				return Bpmn2Package.ALFRESCO_USER_TASK__SCRIPT_PROCESSOR;
			default:
				return -1;
			}
		}
