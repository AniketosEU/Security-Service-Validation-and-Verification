...
import org.eclipse.securebpmn2.util.Securebpmn2ResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>securebpmn2</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Securebpmn2Example {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet
				...
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION,
						new Securebpmn2ResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(Securebpmn2Package.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.securebpmn2"));
				SecurityFlowNode root = Securebpmn2Factory.eINSTANCE
						.createSecurityFlowNode();
