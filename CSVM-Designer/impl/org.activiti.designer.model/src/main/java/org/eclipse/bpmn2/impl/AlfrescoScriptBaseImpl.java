 ...
 * @generated
 */
public class AlfrescoScriptBaseImpl extends BaseElementImpl implements
		AlfrescoScriptBase {
	/**
	...
	public void setRunAs(String newRunAs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.ALFRESCO_SCRIPT_BASE__RUN_AS, oldRunAs, runAs));
	}
	...
	public void setScriptProcessor(String newScriptProcessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.ALFRESCO_SCRIPT_BASE__SCRIPT_PROCESSOR,
