...
public class DocumentRootItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_DIAGRAM);
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_EDGE);
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_LABEL);
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_LABEL_STYLE);
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_PLANE);
			childrenFeatures
					.add(BpmnDiPackage.Literals.DOCUMENT_ROOT__BPMN_SHAPE);
		}
