...
public class AssignmentItemProvider extends BaseElementItemProvider implements
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Assignment_from_feature", "_UI_Assignment_type"),
				Bpmn2Package.Literals.ASSIGNMENT__FROM, true, false, true,
				null, null, null));
	}
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Assignment_to_feature", "_UI_Assignment_type"),
				Bpmn2Package.Literals.ASSIGNMENT__TO, true, false, true, null,
				null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Assignment"));
	}
