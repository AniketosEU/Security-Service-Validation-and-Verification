...
public interface PropertyVerificationService {
    ...
    public PropertyVerificationResult verifyWSDL (String inputSuite, String inputSchema, String inputAlgorithm, int inputKeyLength, String outputSuite, String outputSchema, String outputAlgorithm, int outputKeyLength, String ServiceImplementationUrl);
}
