...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.AlfrescoScriptTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlfrescoScriptTaskItemProvider extends TaskItemProvider implements
	 ...
	 * @generated
	 */
	public AlfrescoScriptTaskItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_AlfrescoScriptTask_script_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_AlfrescoScriptTask_script_feature",
						"_UI_AlfrescoScriptTask_type"),
				Bpmn2Package.Literals.ALFRESCO_SCRIPT_TASK__SCRIPT, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}

	/**
	 * This returns AlfrescoScriptTask.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/AlfrescoScriptTask"));
	}
	...
	public String getText(Object object) {
		String label = ((AlfrescoScriptTask) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AlfrescoScriptTask_type")
				: getString("_UI_AlfrescoScriptTask_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AlfrescoScriptTask.class)) {
