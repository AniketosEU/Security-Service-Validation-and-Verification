...
public class StartEventItemProvider extends CatchEventItemProvider implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_StartEvent_formKey_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_StartEvent_formKey_feature",
								"_UI_StartEvent_type"),
						Bpmn2Package.Literals.START_EVENT__FORM_KEY, true,
						false, false,
	...
	protected void addInitiatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_StartEvent_initiator_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_StartEvent_initiator_feature",
						"_UI_StartEvent_type"),
				Bpmn2Package.Literals.START_EVENT__INITIATOR, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Bpmn2Package.Literals.START_EVENT__FORM_PROPERTIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/StartEvent"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				Bpmn2Package.Literals.START_EVENT__FORM_PROPERTIES,
